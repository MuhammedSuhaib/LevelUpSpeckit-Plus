...
⚠️ **BREAKING CHANGE NOTICE**: In Next.js 16, if you need to redirect based on request conditions, use the `proxy` pattern instead of `middleware`. The `middleware` file has been renamed to `proxy` to clarify network boundary and routing focus.
